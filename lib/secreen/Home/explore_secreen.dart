import 'package:aditum/api/model/searchuser.dart';
      ...
      body: SafeArea(
        child: Column(
          children: [
            Column(
              children: [
                ...
                Row(
                  ...
                  children: [
                    myText("Explore cases", Colors.black, 18, FontWeight.bold),
                    // SizedBox(
                    //   height: 32,
                    //   width: 135,
                    //   child: ToggleButtons(
                    ...
                    Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          IconButton(
                            constraints:
                                BoxConstraints.tight(const Size.fromWidth(40)),
                            onPressed: () {},
            ...
            Expanded(child: LastExampleScreen())
          ],
        ),
      ),
    );
